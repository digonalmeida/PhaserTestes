...
GameplayState.prototype.preload = function(){
	this.game.load.spritesheet('player', 'player.png', 32, 16);
	this.game.load.image('shot', 'shot.png');
	this.game.load.spritesheet('enemyShot', 'enemyShot.png',10, 18);
...
GameplayState.prototype.gameOver = function(victory){
    ...
    if(victory)
    {
        var t = this.siGame.addGuiText(this.game.width/2, 100, "WELL DONE EARTHLING");
        t.anchor.setTo(0.5,1);
        t.alpha = 0;
        var tween1 = this.game.add.tween(t).to( { alpha: 1}, 2000, Phaser.Easing.Linear.None, false);
        
        var t2 = this.siGame.addGuiText(this.game.width/2, 120, "THIS TIME YOU WIN");
    ...
    {
        this.player.explode();
        var t = this.siGame.addGuiText(this.game.width/2, 100, "Game Over");
        t.anchor.setTo(0.5,1);
...
GameplayState.prototype.createGui = function(){
    ...
    var lifesLabel = siGame.addGuiText(0, game.height - 24, "LIFES");
